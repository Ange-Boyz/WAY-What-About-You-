  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="w-full lg:w-1/2 flex flex-col h-screen">
        ...
        <div className="flex-1 px-6 lg:px-16 xl:px-24 py-4 bg-[#BA5F5F0F] lg:bg-transparent rounded-t-3xl sm:rounded-t-4xl lg:rounded-none flex flex-col justify-center">
